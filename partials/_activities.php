        ...
        <div class="container pt-8 pt-md-14">
            <div class="row gx-lg-0 gx-xl-8 gy-10 gy-md-13 gy-lg-0 mb-7 mb-md-10 mb-lg-16 align-items-center">
                <div class="col-md-8 offset-md-2 col-lg-6 offset-lg-1 position-relative order-lg-2" data-cue="zoomIn">
                    ...
                    <figure class="rounded"><img src="<?php echo $activity_item['activity_img'] ?>" srcset="<?php echo $activity_item['activity_img'] ?> 2x" alt="" /></figure>
                </div>
                <!--/column -->
                <div class="col-lg-5 mt-lg-n10 text-center text-lg-start" data-cues="slideInDown" data-group="page-title" data-delay="600">
                    <h1 class="display-1 mb-5"><?php echo $activity_item['activity_name'] ?></h1>
                    <p class="lead fs-25 lh-sm mb-7 px-md-10 px-lg-0"><?php echo $activity_item['activity_descr'] ?></p>
                    <p class="lead fs-25 lh-sm mb-7 px-md-10 px-lg-0"><?php echo $activity_item['activity_day'] ?></p>
                </div>
                <!--/column -->
            </div>
            <!-- /.row -->
