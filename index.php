                ...
                <div class="header-style-center">
                    ...
                    <div class="main-menu-area text-center">
                        <nav class="navigation-menu">
                            <ul>
                                <?php foreach (MENU_HEADER as $menu_header_item) : ?>
                                    <li><a href="<?php echo $menu_header_item['link'] ?>"><span><?php echo $menu_header_item['name'] ?></span></a></li>
                                <?php endforeach ?>
                            </ul>
                        </nav>
                    </div>
            ...
            <div class="hero-area-three">
                <div class="swiper-container hero-slider-three-active">
                    <div class="swiper-wrapper">
                        <?php foreach (SLIDE_SHOW as $slide_show_item) : ?>
                                        ...
                                        <div class="col-lg-6 col-md-6 order-2 order-md-1">
                                            <div class="hero-area-three-post text-left">
                                                <div class="hero-area-three-post-author">
                                                    By <a href="#"><?php echo $slide_show_item['author'] ?></a>
                                                </div>
                                                <h1 class="title"><a href="<?php echo $slide_show_item['link'] ?>"><?php echo $slide_show_item['title'] ?></a>
                                                </h1>
                                                <p class="dec mt-4"><?php echo $slide_show_item['description'] ?></p>
                                                <div class="hero-area-three-post-meta">
                                                    <span class="hero-area-three-post-date">
                                                        <a href="#"><?php echo $slide_show_item['date_day'] ?></a>
                                                    </span>
                                                    <span><?php echo $slide_show_item['reading_time'] ?> min read</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 order-1 order-md-2">
                                            <div class="hero-three-box">
                                                <div class="hero-three-inner-image">
                                                    <img src="<?php echo $slide_show_item['img'] ?>" alt="<?php echo $slide_show_item['img_alt_text'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="hero-three-category">
                                <div class="category-step-1" data-aos="fade-up">
                                    <?php foreach (CATEGORY_1 as $category_item) : ?>
                                        <a href="#" class="btn-primary-three btn-large"><?php echo $category_item['name'] ?></a>
                                    <?php endforeach ?>

                                </div>
                                <div class="category-step-2" data-aos="fade-up">
                                    <?php foreach (CATEGORY_2 as $category_item) : ?>
                                        <a href="#" class="btn-primary-three btn-large"><?php echo $category_item['name'] ?></a>
                                    <?php endforeach ?>
                                </div>
                                <div class="category-step-3" data-aos="fade-up">
                                    <?php foreach (CATEGORY_3 as $category_item) : ?>
                                        <a href="#" class="btn-primary-three btn-large"><?php echo $category_item['name'] ?></a>
                                    <?php endforeach ?>
                                    <!---------------------->
                                </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <?php foreach (POST as $post_item) : ?>
                                <div class="single-recent-article-item" data-aos="fade-up">
                                    <a href="<?php echo $post_item['link'] ?>" class="recent-article-thum">
                                        <img src="<?php echo $post_item['img'] ?>" alt="<?php echo $post_item['img_alt_text'] ?>" />
                                    </a>
                                    <div class="recent-article-content">
                                        <div class="recent-article-post-author">
                                            By <a href="<?php echo $post_item['link'] ?>"><?php echo $post_item['author'] ?></a>
                                        </div>
                                        <h3 class="title"><a href="blog-details.html"><?php echo $post_item['title'] ?></a>
                                        </h3>
                                        <p class="dec mt-3"><?php echo $post_item['description'] ?></p>
                                        <div class="recent-article-post-meta">
                                            <span class="post-date">
                                                <a href="<?php echo $post_item['link'] ?>"><?php echo $post_item['date_day'] ?></a>
                                            </span>
                                            <span><?php echo $post_item['reading_time'] ?> min read</span>
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach ?>
